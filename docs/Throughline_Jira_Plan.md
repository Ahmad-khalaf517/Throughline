...
**Status:** Derived from ERD/Data Model v1.7, Technical Requirements & Lineage Invariants v1.4, Module Boundaries v1.1, API Contracts v1.1, and Project Setup & Configuration Plan v1.4. Parent of the day-by-day implementation plan and of coding. v1.3: E1-S6 updated for open sign-up + mandatory email verification, replacing invite-only + allowlist (ERD Appendix B round 9).
